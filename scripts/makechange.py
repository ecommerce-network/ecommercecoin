...
Open the wallets with ecommerce-serivce like so:

./ecommerce-service -w walletA.wallet -p yourpass --rpc-password test --bind-port 8070
./ecommerce-service -w walletB.wallet -p yourpass --rpc-password test --bind-port 8071
