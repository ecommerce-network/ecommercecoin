...
Open the wallets with meteor-serivce like so:

./meteor-service -w walletA.wallet -p yourpass --rpc-password test --bind-port 8070
./meteor-service -w walletB.wallet -p yourpass --rpc-password test --bind-port 8071
