...
### EcommerceCoin Build Information
...
cmake .. -DBOOST_ROOT=/home/ecommercecoin/boost_1_59_0
make -j4
```

**If self compiled, please provide of your EcommerceCoin CMake output at the default verbosity**:
```
...
**Binary Reported:** <!-- does this issue affect zedwallet, EcommerceCoind, ecommerce-service, miner? -->
